    ...
    <nav className="sticky top-0 z-50"
      ...
      <div className="w-full px-6 py-0 flex items-center justify-between" style={{ height: '60px' }}>
        ...
        <div className="hidden md:flex items-center gap-1 absolute left-1/2 transform -translate-x-1/2">
          ...
          {!pathname.startsWith('/admin') && <NavLink href="/contact" active={isActive('/contact')} label={dict[lang].footer.links.contact} />}
      ...
      {menuOpen && (
        <div className="md:hidden fixed right-4 top-16 w-64 rounded-xl shadow-2xl border overflow-hidden animate-fsu"
          ...
          <div className="px-4 py-4 flex flex-col gap-1">
            ...
            {!pathname.startsWith('/admin') && <MobLink href="/contact" label={dict[lang].footer.links.contact} active={isActive('/contact')} onClick={close} />}
